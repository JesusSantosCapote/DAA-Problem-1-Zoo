...
Es decir, para este caso, con formar solo grupo filas con los elementos de $a_i$ y $b_i$
obtengo la cantidad m\'axima de grupos menos uno. Ese grupo de menos ser\'a un grupo columna
...
la soluci\'on \'optima si no es posible crear grupos columna.
